...
public sealed class XPubXSubInteropTests
{
    ...
    public async Task ZmqSharpXPub_NetMQXSub_ObservesAndBroadcasts()
    {
        ...
        await using var xpub = new ZXPubSocket(new ZSocketOptions { ReceiveSurface = ZReceiveSurface.Callback });
    ...
    public async Task NetMQXPub_ZmqSharpXSub_ReceivesUnfiltered()
    {
        ...
        await using var xsub = new ZXSubSocket(new ZSocketOptions { ReceiveSurface = ZReceiveSurface.Callback });
